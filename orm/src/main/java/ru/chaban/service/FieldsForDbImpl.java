...
public class FieldsForDbImpl implements FieldsForDb {
    ...
    public void create(Object myObject) throws IllegalAccessException {
        createSimpleObject(Json.createObjectBuilder(), Json.createArrayBuilder(), myObject).build();
    }

    public JsonObjectBuilder createSimpleObject(JsonObjectBuilder jO, JsonArrayBuilder aB, Object myObject) throws IllegalAccessException {
